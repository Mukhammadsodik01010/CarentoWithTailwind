  ...
  return (
    <div>
      ...
      <div className="w-full flex items-center justify-center py-30">
        <div className="sm:min-w-[500px] min-w-[330px] border-gray-400 border-2 rounded-xl shadow-xl/30 flex flex-col gap-2 items-center p-5 sm:p-10">
          ...
          <div className="w-full flex items-center justify-between">
            <div className="flex items-center">
              <Checkbox
                ...
                defaultChecked
              />
              <p className="text-md text-gray-500">Remember me</p>
            </div>
            <p className="text-md text-gray-500">Forgot password?</p>
          </div>
          <button
            onClick={SignUpNav}

  ...
  const LetSide = (
    <>
      ...
      <Accordion defaultExpanded>
        ...
        <AccordionDetails>
          <div className="font-[urbanist] flex flex-col gap-2 items-start">
            <div className="flex items-center gap-1">
              <Checkbox
                style={{
                  color: black,
                ...
                <div className=" relative max-w-[400px] h-100">
                  ...
                  <div className="p-4 flex flex-col gap-4 rounded-xl border-gray-300 border  w-full bg-white absolute top-38">
                    <div className="flex items-center gap-1 bg-white border-gray-300 border w-40 justify-center rounded-xl h-6 -mt-7 ml-[40%]">
                      ...
                      <p className="text-sm font-extralight">
                        3.22{" "}
                        <span className="text-gray-400">(419 reviews)</span>
                      </p>
                    </div>
                ...
                <div className=" relative max-w-[400px] h-100">
                  ...
                  <div className="p-4 flex flex-col gap-4 rounded-xl border-gray-300 border  w-full bg-white absolute top-38">
                    <div className="flex items-center gap-1 bg-white border-gray-300 border w-40 justify-center rounded-xl h-6 -mt-7 ml-[40%]">
                      ...
                      <p className="text-sm font-extralight">
                        2.34{" "}
                        <span className="text-gray-400">(243 reviews)</span>
                      </p>
                    </div>
                    <h1 className="text-xl font-bold">
                      Malibu Chevrolet Turbo
                    </h1>
                    <div className="flex items-center gap-1">
                      <LocationOnIcon
                        fontSize="small"
                ...
                <div className=" relative max-w-[400px] h-100">
                  ...
                  <div className="p-4 flex flex-col gap-4 rounded-xl border-gray-300 border  w-full bg-white absolute top-38">
                    <div className="flex items-center gap-1 bg-white border-gray-300 border w-40 justify-center rounded-xl h-6 -mt-7 ml-[40%]">
                      ...
                      <p className="text-sm font-extralight">
                        4.17{" "}
                        <span className="text-gray-400">(586 reviews)</span>
                      </p>
                    </div>
                ...
                <div className=" relative max-w-[400px] h-100">
                  ...
                  <div className="p-4 flex flex-col gap-4 rounded-xl border-gray-300 border  w-full bg-white absolute top-38">
                    <div className="flex items-center gap-1 bg-white border-gray-300 border w-40 justify-center rounded-xl h-6 -mt-7 ml-[40%]">
                      ...
                      <p className="text-sm font-extralight">
                        4.00{" "}
                        <span className="text-gray-400">(403 reviews)</span>
                      </p>
                    </div>
                ...
                <div className=" relative max-w-[400px] h-100">
                  ...
                  <div className="p-4 flex flex-col gap-4 rounded-xl border-gray-300 border  w-full bg-white absolute top-38">
                    <div className="flex items-center gap-1 bg-white border-gray-300 border w-40 justify-center rounded-xl h-6 -mt-7 ml-[40%]">
                      ...
                      <p className="text-sm font-extralight">
                        4.24{" "}
                        <span className="text-gray-400">(593 reviews)</span>
                      </p>
                    </div>
